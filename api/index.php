...
try {
    switch ($action) {
        ...
        case 'admin_save_video_transcode_config': admin_save_video_transcode_config($pdo, $input); break;
        case 'admin_set_fragmentation_time': admin_set_fragmentation_time($pdo, $input); break;
        ...
        case 'get_folders': 
            ...
            respond(true, video_discover_subfolders($pdo, $_GET['path'] ?? '', '', 'ALL', $recursive)); 
            break;
        ...
        case 'get_user_all_subscriptions': get_user_all_subscriptions($pdo); break;
        case 'group_create': group_create($pdo, $input); break;
        case 'group_edit': group_edit($pdo, $input); break;
        case 'group_get_pending_subs': group_get_pending_subs($pdo, $input); break;
        case 'group_approve_sub': group_approve_sub($pdo, $input); break;
        case 'group_decline_sub': group_decline_sub($pdo, $input); break;
        ...
        case 'admin_add_to_transcode_queue': // Alias para evitar error reportado por usuario
